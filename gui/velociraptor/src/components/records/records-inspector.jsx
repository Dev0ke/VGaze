...
import HuntOverview from './records-overview.jsx';
import HuntRequest from './records-request.jsx';
import HuntClients from './records-clients.jsx';
import HuntNotebook from './records-notebook.jsx';
...
class HuntInspector extends React.Component {
    ...
    setDefaultTab = (tab) => {
        ...
        this.props.history.push(
            "/records/application/" + this.props.hunt.hunt_id + "/" + tab);
    }
