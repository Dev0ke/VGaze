...
export default class HexView extends React.Component {
  ...
  componentDidUpdate(prevProps) {
      if (prevProps.byte_array !== this.props.byte_array) {
          this.updateRepresentation();
      }
  }
  ...
  byteArrayToAscii = (byteArray) => {
      ...
      byteArray.forEach((byte, index) => {
          ...
          asciiString += byte > 0x20 && byte < 0x7e ? String.fromCharCode(byte) : ' ';
      });
      return asciiString;
  };
